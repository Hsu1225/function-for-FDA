## function for financial data analysis
...
##functions for calculating skewness and kurtosis need be written 
##by yourself or from other packages, e.g., e1071
...
zy_v<-function(op, h, l, cl, alphax = 1.34){     ##this produces the same answer as 
